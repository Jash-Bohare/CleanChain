...
// Navigation component (you can replace this with your own)
const Navigation = () => {
  return (
...
const render = (status) => {
  switch (status) {
    ...
    case Status.FAILURE:
      return (
        <div className="flex items-center justify-center h-full">
          <div className="text-red-400">Error loading Google Maps. Please check your API key.</div>
        </div>
      );
    default:
      return null;
  ...
  if (!apiKey || apiKey.trim() === '') {
    return (
      <div className="min-h-screen bg-[#0d0d0d] relative">
        <Navigation />
        <div className="pt-20 px-6 h-screen flex items-center justify-center">
          <div className="text-center">
            <h1 className="text-white text-2xl font-bold mb-4">Google Maps API Key Required</h1>
            <p className="text-gray-400 mb-4">
              To use the map feature, you need to set up a Google Maps API key:
            </p>
            <div className="bg-gray-800 text-green-400 px-4 py-2 rounded mb-6">
              <p className="text-sm mb-2">1. Add to .env file:</p>
              <code className="block">
              REACT_APP_GOOGLE_MAPS_API_KEY=your_api_key_here
              </code>
            </div>
            <div className="text-gray-500 text-sm mt-4 space-y-2">
              <p className="font-semibold mb-3">How to get your API key:</p>
              <ol className="text-left max-w-md mx-auto space-y-1">
                <li>1. Go to <a href="https://console.cloud.google.com/" target="_blank" className="text-blue-400 hover:underline">Google Cloud Console</a></li>
                <li>2. Create/select a project</li>
                <li>3. Enable "Maps JavaScript API"</li>
                <li>4. Create credentials → API Key</li>
                <li>5. Configure API key restrictions:</li>
                <li className="ml-4">• Select "HTTP referrers (web sites)"</li>
                <li className="ml-4">• Add your domain</li>
                <li>6. Restart your dev server after adding the key</li>
              </ol>
            </div>
          </div>
        </div>
      ...
      <div className="pt-20 px-6 h-screen flex flex-col">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-4">
            <div className="w-10 h-10 bg-transparent border-2 border-white rounded-lg flex items-center justify-center rotate-45">
        ...
        <div className="mt-4 text-center">
          <p className="text-gray-400 text-sm">
            Click on the map to add markers • Click markers to view info and edit • Maximum 3 markers allowed
          </p>
        </div>
      </div>
          ...
          <div className="bg-[#1a1a1a] border border-gray-700 rounded-lg p-6 w-full max-w-md mx-4">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-[#0d0d0d] border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-white focus:ring-1 focus:ring-white transition-all"
                  autoFocus
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-3 bg-[#0d0d0d] border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-white focus:ring-1 focus:ring-white transition-all resize-none"
                />
              </div>
            ...
            <div className="flex space-x-3 mt-6">
              ...
              <button
                ...
                className="flex-1 py-2 px-4 bg-white text-black font-semibold rounded-lg hover:bg-gray-100 transition-colors"
              >
